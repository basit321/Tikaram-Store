...
export default function RecieptOrder2() {
    ...
    return (
        <View style={styles.conatainer}>
            ...
            <ScrollView style={{flex:1}} >
                ...
                <View  >
                <Box style={{...styles.Box,height:46}}  
             mt='2%' mx='auto'
...
>
    ...
    <VStack style={{flex:1,backgroundColor:"#FFD5D5",borderRadius:15}}>
    <HStack mx='auto' my='auto' width='90%'>
...
<LinearGradient
 ...
 style={{ ...styles.Btn }}
>
 <Text style={{ color: "white", fontFamily: 'arabicBold',fontSize:14 }}>Sent delivered handed</Text>
</LinearGradient>
</TouchableOpacity>
