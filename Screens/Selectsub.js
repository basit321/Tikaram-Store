...
<Box style={{...styles.Box,height:50,}} bgColor='white' 
...
<Box style={{...styles.Box,height:50,borderColor:'#00CBA4'}} bgColor='white' borderWidth='1'  
borderColor='gray.50' shadow='2' mt='10%'
